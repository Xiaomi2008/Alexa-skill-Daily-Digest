...
var stateHandlers = {
    startModeIntentHandlers : Alexa.CreateStateHandler(constants.states.START_MODE, {
        ...
        'LaunchRequest' : function () {
            ...
            // var message = 'Welcome to Daily Digest. You can say, start the news, to begin.';
            // var reprompt = 'You can say, start the news, to begin.';
        ...
        'Unhandled' : function () {
            var message = 'Sorry, I could not understand. Please say, start the news, to begin.';
            this.response.speak(message).listen(message);
            this.emit(':responseReady');
        }
    }),
    playModeIntentHandlers : Alexa.CreateStateHandler(constants.states.PLAY_MODE, {
        ...
        'LaunchRequest' : function () {
            ...
            if (this.attributes['playbackFinished']) {
                this.handler.state = constants.states.START_MODE;
                message = 'Welcome to Daily Digest, You can say, start the news to begin.';
                reprompt = 'You can say, start the news, to begin.';
            } else {
        ...
        'AMAZON.HelpIntent' : function () {
            ...
            var message = 'You are listening to the Daily Digest. You can say, Next or Previous to navigate through the playlist. ' +
